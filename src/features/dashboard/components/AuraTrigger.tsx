...
export function AuraTrigger() {
    ...
    return (
        <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#bfff00] text-black rounded-lg font-bold text-sm hover:scale-105 transition-all shadow-lg shadow-[#bfff00]/20"
        >
