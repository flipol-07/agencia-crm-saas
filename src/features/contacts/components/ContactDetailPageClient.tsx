    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black uppercase tracking-tight">{currentContact?.company_name}</h1>
                    {currentContact?.contact_name && (
                        <p className="text-gray-400">{currentContact.contact_name}</p>
                    )}
                </div>
            </div>

            {/* Ficha 360° */}
            <ContactDetail360 contact={currentContact} onUpdate={updateContact} />
        </div>
    )
}
