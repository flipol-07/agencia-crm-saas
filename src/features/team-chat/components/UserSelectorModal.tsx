            ...
            <div className="bg-zinc-900 border border-white/10 rounded-2xl w-full max-w-md flex flex-col max-h-[80vh] animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-4 border-b border-white/10">
                    <input
                        ...
                        className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-brand outline-none"
                    />
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-1">
                            {users.map(user => (
                                ...
                                >
                                    <div className="w-10 h-10 rounded-full bg-lime-500/20 text-lime-500 flex items-center justify-center font-bold text-lg overflow-hidden relative">
                                        {user.avatar_url ? (
